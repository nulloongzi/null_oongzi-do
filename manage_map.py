...
<head>
    ...
    <script type="module">
        ...
        function generateRiceName() {{
            const riceTypes = [
                "현미밥", "백미밥", "흑미밥", "보리밥", "콩밥", "오곡밥", 
                "차조밥", "기장밥", "누룽지", "숭늉", "볶음밥", "비빔밥",
                "김밥", "주먹밥", "유부초밥", "덮밥", "국밥", "솥밥", "약밥", "죽"
            ];
            const chars = "abcdefghijklmnopqrstuvwxyz0123456789";
            
            const rice = riceTypes[Math.floor(Math.random() * riceTypes.length)];
            let suffix = "";
            for (let i = 0; i < 3; i++) {{
        ...
        // 프로필 UI 업데이트
        function updateProfileUI(name, createdAt) {{
    ...
    <style>
        * {{ box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Apple SD Gothic Neo", "Malgun Gothic", "맑은 고딕", sans-serif; }}
        ...
        :root {{ 
            ...
            --today-color: #d35400; 
            --nurungji-dark: #6d4c41; /* 탄 누룽지색 */
            --nurungji-card: #fbc02d; /* 짙은 노란색 */
        }}
...
<body>
    ...
    <div id="profileOverlay" class="profile-overlay" onclick="toggleProfileCard()">
        <div class="profile-card" onclick="event.stopPropagation()">
            <div class="pc-header">
                <span id="pcNickname" class="pc-nickname">누룽지 굽는 중...</span>
