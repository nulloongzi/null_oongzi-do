    ...
    <script type="module">
        ...
        function generateRiceName() {{
            ...
            const riceData = [
                ...
                // [레어] 25번 (가중치 1, 합 1) -> 약 0.2% 확률
                {{name: "밥아저씨", weight: 1}}
            ];

            // 2. 가중치 기반 랜덤 선택 (Roulette Selection)
            let totalWeight = 0;
...
<body>
    ...
    <div id="profileOverlay" class="profile-overlay" onclick="toggleProfileCard()">
        <div class="profile-card" onclick="event.stopPropagation()">
            <button id="loginBtn" class="btn-google-login" onclick="loginWithGoogle()" style="display:none;">
